...
options.binary_location =r"C:\Users\AW\AppData\Local\360Chrome\Chrome\Application\360chrome.exe"
options.add_experimental_option('excludeSwitches', ['enable-automation'])
browser = webdriver.Chrome(executable_path=r'C:\Users\AW\AppData\Local\360Chrome\Chrome\Application\chromedriver.exe',options=options)
